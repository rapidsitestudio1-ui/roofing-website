...
! function(t) {
    ...
    V.ui.dialog, V.widget("ui.progressbar", {
        ...
        _createRange: function() {
            var t = this.options;
            t.range ? (!0 === t.range && (t.values ? t.values.length && 2 !== t.values.length ? t.values = [t.values[0], t.values[0]] : Array.isArray(t.values) && (t.values = t.values.slice(0)) : t.values = [this._valueMin(), this._valueMin()]), this.range && this.range.length ? (this._removeClass(this.range, "ui-loan-range-min ui-loan-range-max"), this.range.css({
                left: "",
                bottom: ""
            })) : (this.range = V("<div>").appendTo(this.element), this._addClass(this.range, "ui-loan-range")), "min" !== t.range && "max" !== t.range || this._addClass(this.range, "ui-loan-range-" + t.range)) : (this.range && this.range.remove(), this.range = null)
        },
