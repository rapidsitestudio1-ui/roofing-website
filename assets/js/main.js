(function($) {
    ...
    // prelaoder
    let span = $('.letter'),
        tlSmell = new TimelineMax({
            repeat: -1
        });
    tlSmell
        .staggerFromTo($('svg .smell'), 3, {
            y: 50,
            autoAlpha: 0.5
        }, {
            y: -20,
        ...
        iframe: {
            patterns: {
                youtube: {
                    ...
                    src: '//www.youtube.com/embed/%id%?autoplay=1&vq=hd1080&hd=1&rel=0'
                }
            }
        }
    });
